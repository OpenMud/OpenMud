import { System, SystemType, Scene, Actor } from "excalibur";
...
export class NetworkSystem extends System<NetworkedComponent> {
  ...
  private updateDisconnected(entities: ex.Entity[], delta: number) {
